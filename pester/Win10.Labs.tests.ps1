...
$config.Run.Path='C:\Users\student\aud1-labs\pester\Win10.Labs.tests.ps1'
...
Describe '507 Labs' {
  ...
  Context 'Lab 2.2' {
    ...
    It 'Part 3 - InstalledSoftware script output includes Firefox' {
      $res = C:\users\student\aud1-labs\scripts\InstalledSoftware.ps1
  ...
  Context 'Lab 2.3' {
    ...
    It 'Part 2 - UserRights.psm1 returns admin for debug privilege' {
      Import-Module C:\users\student\aud1-labs\scripts\UserRights.psm1
  ...
  Context 'Lab 2.3: AWS VPN to DC' -Skip:$skipDC { 
    ...
    It 'Part 5 - ADAuditGeneric script returns expected results' {
      ...
      $res = (C:\Users\student\aud1-labs\scripts\ADAuditGeneric.ps1 -Server 507dc -Credential $cred)
  ...
  Context 'Lab2.4-NessusSavedScan' {
    BeforeAll {      
      $cisScan = [system.xml.xmldocument](Get-Content c:\users\student\aud1-labs\scans\Win10CIS_L1Demo.nessus)
      $credScan = [system.xml.xmldocument](Get-Content c:\users\student\aud1-labs\scans\Win10demo.nessus)
    ...
    It 'Nessus CIS Compliance Scan File Exists' {
      (Test-Path -Type Leaf -Path C:\Users\student\aud1-labs\scans\Win10CIS_L1Demo.nessus) | Should -BeTrue
    }

    It 'Nessus Credentialed Scan File Exists' {
      (Test-Path -Type Leaf -Path C:\Users\student\aud1-labs\scans\Win10demo.nessus) | Should -BeTrue
    }
  ...
  Context 'Lab3.4: Ubuntu scan results' {
    BeforeAll {
      $scan = [system.xml.xmldocument](Get-Content C:\users\student\aud1-labs\scans\LinuxDemo.nessus)
  ...
  Context 'Lab 5.2' {
    ...
    It 'Part 5 - JuiceShop source code ZIP file exists' {
      Test-Path -Type Leaf -Path C:\Users\student\aud1-labs\SAST\juice-shop.zip |
        Should -BeTrue
    }
  }
  ...
  Context 'Lab5.3' {
    ...
    It 'Part 2 - Valid usernames return password questions' {
      ...
      Test-Path -Type Leaf -Path C:\Users\student\aud1-labs\injection\namesLower.txt |
        Should -BeTrue
      #Read the names file
      $nameFile = Get-Content C:\Users\student\aud1-labs\injection\namesLower.txt
    ...
    It 'Part 3 - Password for Jim works' {
      ...
      Test-Path -Type Leaf -Path C:\Users\student\aud1-labs\injection\passwords.txt |
        Should -BeTrue
      #Test that Jim's password is there
      $passwords = Get-Content C:\Users\student\aud1-labs\injection\passwords.txt
